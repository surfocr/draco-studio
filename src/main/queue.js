...
class BatchQueue {
  ...
  _canRun(job) {
    // Resolve the actual provider that will execute this job, matching orchestrator fallback logic
    const provider = this.orchestrator.resolveProvider(job.type) || '_default';
